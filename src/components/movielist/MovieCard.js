...
import {addFavorite, handleMovieClick, removeFavorite} from "../../actions";
...
const MovieCard = (props) => {
  ...
  if (props.favorites.find((item) => item.id === props.movie.id)) {
    isInFavorites = true;
  }
  ...
  if(!isInFavorites){
    favorite = (
        <StyledFavorite>
          <IconButton  aria-label="Add Favorite" color='secondary' onClick={() => props.addFavorite(props.movie)}>
            <FavoriteBorderIcon />
          </IconButton >
        </StyledFavorite>
    );
    ...
    favorite = (
        <StyledFavorite>
          <IconButton  aria-label="Remove Favorite" color='secondary' onClick={() => props.removeFavorite(props.movie)}>
            <FavoriteIcon />
          </IconButton >
        </StyledFavorite>
    );
...
export default connect(mapStateToProps, { handleMovieClick, removeFavorite, addFavorite })(
  MovieCard
);
